...
export function PainPointBand() {
  ...
  return (
    ...
    <div ref={wrapperRef} style={{ height: "200vh", background: "var(--color-surface-container-low)" }}>
      ...
      >
        <h2 className="mx-auto max-w-[1100px] text-center text-[28px] font-bold leading-[1.08] tracking-[-0.02em] text-white sm:text-[38px] md:text-[48px] lg:text-[58px]" style={{ fontFamily: "var(--font-league-spartan)" }}>
