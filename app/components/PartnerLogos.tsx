...
function LogoNode({ name }: { name: string }) {
    ...
    return (
      <div className="flex items-center gap-2">
        <svg viewBox="0 0 40 40" className="h-9 w-9" fill="none">
          ...
          <path d="M11 28 L20 12 L29 28 Z" stroke="white" strokeWidth="1.5" fill="none" />
        </svg>
    ...
    return (
      <div className="flex items-center gap-2">
        <svg viewBox="0 0 40 40" className="h-8 w-8" fill="none">
          <path d="M4 30 L20 8 L36 30 Z" stroke="white" strokeWidth="1.5" fill="none" />
          <path d="M4 30 H36" stroke="white" strokeWidth="1.5" />
        </svg>
    ...
    return (
      <div className="flex flex-col items-center">
        <svg viewBox="0 0 60 24" className="h-5 w-12">
          <path d="M2 22 Q 30 -4 58 22" stroke="white" strokeWidth="2" fill="none" />
        </svg>
  ...
  if (name === "The Great Seal") {
    return (
      <div className="flex flex-col items-center">
        <svg viewBox="0 0 40 40" className="h-9 w-9" fill="none">
          <circle cx="20" cy="20" r="18" stroke="white" strokeWidth="1" />
          <circle cx="20" cy="20" r="13" stroke="white" strokeWidth="0.8" />
          <path d="M12 20 L20 14 L28 20 L24 26 H16 Z" stroke="white" strokeWidth="0.8" fill="none" />
        </svg>
  ...
  if (name === "Harvest Fields") {
    return (
      <div className="flex items-center gap-2">
        <svg viewBox="0 0 40 40" className="h-8 w-8" fill="none">
          <path d="M8 28 Q 20 8 32 28 Z" stroke="white" strokeWidth="1.4" fill="none" />
          <path d="M14 28 V 20 M20 28 V 16 M26 28 V 20" stroke="white" strokeWidth="1.2" />
        </svg>
        <div className="text-[10px] font-semibold leading-tight tracking-wide">
          HARVEST FIELDS<br />
  ...
  return (
    <div className="flex flex-col items-center">
      <svg viewBox="0 0 40 24" className="h-6 w-10" fill="none">
        <path d="M2 22 L12 6 L20 14 L28 4 L38 22 Z" stroke="white" strokeWidth="1.4" fill="none" />
      </svg>
    ...
    <section className="relative -mt-px">
      <div className="w-full px-8 py-8 md:px-16">
        <div className="mx-auto max-w-[var(--container-content)] grid grid-cols-2 items-center gap-8 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-10">
          {logoNames.map((name) => (
            <div key={name} className="flex h-16 items-center justify-center text-white" aria-label={name}>
              <LogoNode name={name} />
            </div>
          ))}
        </div>
